...
function connectToAzure() {
    try {
        ...
        # Connect to Azure tenant with the service principal credentials
        ...
        Connect-AzAccount -Credential $servicePrincipalCredentials -Tenant $config.tenantId -ServicePrincipal -ErrorAction Stop | Out-Null;
